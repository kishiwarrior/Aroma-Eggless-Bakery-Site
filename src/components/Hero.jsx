        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center space-x-3 bg-white/80 dark:bg-gray-900/70 backdrop-blur px-4 py-2 rounded-full shadow-sm border border-primary-100 dark:border-gray-800">
              <span className="text-sm font-semibold text-primary-700 dark:text-primary-300">Fresh • Pure Veg • Since 2022</span>
          ...
          <div className="relative">
            <div className="bg-white/90 dark:bg-gray-900/80 backdrop-blur rounded-2xl shadow-2xl p-8 border border-primary-100 dark:border-gray-800">
              <div className="aspect-square bg-gradient-to-br from-primary-200 to-primary-400 dark:from-gray-800 dark:to-gray-700 rounded-xl flex items-center justify-center relative overflow-hidden">
                ...
                >
                  <SwiperSlide>
                    <img src="/assets/signature-bread-1.jpg" alt="Signature Bread 1" className="w-full h-full object-cover" />
                  </SwiperSlide>
                  <SwiperSlide>
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 text-center text-sm">
                ...
                <div className="bg-primary-50 dark:bg-gray-800 rounded-lg p-3">
                  <p className="font-bold text-lg text-primary-700 dark:text-primary-300">2+</p>
        ...
        <div className="container-custom py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">🥖</span>
              </div>
              <h3 className="font-serif font-semibold text-xl mb-2 text-gray-900 dark:text-white">Authentic Recipes</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif font-semibold text-xl mb-2 text-gray-900 dark:text-white">Baked with Love</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif font-semibold text-xl mb-2 text-gray-900 dark:text-white">Quality First</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif font-semibold text-xl mb-2 text-gray-900 dark:text-white">Honestly Priced</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
