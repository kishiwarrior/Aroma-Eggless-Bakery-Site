        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Pure vegetarian bakery serving fresh, delicious baked goods since 2021.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/people/Aroma-Bakery/100094550372757/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <span className="sr-only">Facebook</span>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/aroma_bakeryoffical/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <div className="flex flex-col">
                  ...
                  <a href="tel:8016739666" className="text-gray-400 hover:text-white transition-colors mt-1">
                    8016739666
                  </a>
                </div>
              </li>
